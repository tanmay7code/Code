...
function z = EvaluateObjectives(x)
    ...
    E=36.75; v_e=2.6; w_e=10; d_e=100; c_t=6;  % carbon tax coefficient (new parameter)
    ...
    % Objective Function 1 (with carbon tax policy)
    ...
    % Apply carbon tax policy to the first objective function
    f1 = f_1 + c_t * f2;  % Carbon tax adjustment
