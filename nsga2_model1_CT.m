...
maxgen=5; %maximum no of generations to be performed
...
%constraint 1 (less than type)
g1=@(y1,y2,y3,y4,y5,y6) y2*y5-(sigma/(1+l_1))*((1+trk1+y1*y6)^(1+l_1)-(1+trk1)^(1+l_1));


%constraint 2 (less than type )
g2=@(y1,y2,y3,y4,y5,y6) (y3-y2)*y5-(lambda/(1+l_2))*((1+tpk1+(y4-y1)*y6)^(1+l_1)-(1+tpk1)^(1+l_2));
